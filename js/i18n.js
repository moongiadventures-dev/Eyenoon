  ...
  var STRINGS = {
    en: {
      ...
      contact: {
        ...
        lead:
          "Reach Eye Noon Optical by phone, email, or KakaoTalk. Visit us in Los Angeles — we sell online and in store, so please get in touch before you order if you have questions about availability.",
        ...
        exams: "Eye exams",
        examsVal: "Monday, Wednesday & Saturday — by appointment only",
        addr: "Address",
        findOnline: "Find us online",
      },
      optical: {
    ...
    ko: {
      ...
      contact: {
        ...
        lead:
          "전화, 이메일, 카카오톡으로 아이눈 안경원에 연락해 주세요. LA 매장을 방문하실 수 있습니다. 온라인·매장 모두 판매하므로 재고 문의는 주문 전에 미리 연락 주세요.",
        rxTitle: "콘택트렌즈 처방전",
        rxBody:
