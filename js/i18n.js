  ...
  var STRINGS = {
    en: {
      ...
      lenses: {
        ...
        filterBiweekly: "Bi-weekly · 6 mo supply",
        filterMonthly: "Monthly · 6 mo supply",
        filterColor: "Color",
      ...
      checkout: {
        ...
        shipHelp: "We use your address to ship your order. Shipping is a flat $15 per order.",
        ...
        taxEstNote: "Shipping is a flat $15 per order.",
    ...
    ko: {
      ...
      lenses: {
        ...
        filterBiweekly: "2주 교체 · 6개월분",
        filterMonthly: "한 달 교체 · 6개월분",
        filterColor: "컬러",
      ...
      checkout: {
        ...
        phone: "전화번호",
        shipBlock: "배송 주소",
        shipHelp: "주소는 배송에만 사용됩니다. 배송비는 주문당 $15 정액입니다.",
        street: "도로명 주소",
        apt: "동·호수",
        optional: "(선택)",
        city: "시",
